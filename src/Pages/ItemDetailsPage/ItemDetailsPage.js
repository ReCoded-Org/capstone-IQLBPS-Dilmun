...
const ItemDetailsPage = () => {
    return (
        <div data-testid='item-details-page' className='md:flex h-full text-background p-6 bg-background gap-4 mt-11'>
            <div>
                <img className='max-h-full min-h-[600px] mb-6 md:mb-0' src="https://images.unsplash.com/photo-1553062407-98eeb64c6a62?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8YmFnfGVufDB8fDB8fA%3D%3D&w=1000&q=80" alt="headphones" />
            </div>
