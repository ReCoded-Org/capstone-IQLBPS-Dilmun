    ...
    <form  className=" bg-tertiary ">
        <div className="bg- py-6 px-10 sm:max-w-md w-full rounded-md">
                        ...
                        <div className="flex flex-col justify-center gap-2">
                                ...
                                <button type="button" onClick={handleClick} className=" rounded-full  p-3 w-full sm:w-56 bg-background hover:border hover:border-primary hover:bg-tertiay text-primary text-lg font-semibold " >
                                Save
                                </button>
                                <button type="button" className=" rounded-full  p-3 w-full sm:w-56  bg-background hover:border hover:border-primary text-primary text-lg font-semibold " >
                                Cancel
                                </button>
