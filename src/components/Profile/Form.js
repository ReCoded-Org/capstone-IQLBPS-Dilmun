    ...
    <form  className=" w-full bg-tertiary rounded-lg">
        <div className="bg- py-6 px-10 sm:max-w-md w-full rounded-md">
                        ...
                        <div className="flex justify-center p-2">
                            <button type="button"className=" rounded-full  p-3 w-full sm:w-56  hover:bg-terinary text-primary text-lg font-semibold " >Upload</button>
                        </div>
                    </div>
                </div> 
                        <div className="flex flex-col justify-center gap-2">
                                <input type="text" onChange={e=>setfirstName(e.target.value)} className=" w-full p-1 bg-background rounded-lg mt-3 "  placeholder=" First name " {...register('firstName')}/>
                                   {error?
