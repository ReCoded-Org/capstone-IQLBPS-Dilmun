...
// import axios from "axios";
 ...
 function Profile(){
  ...
  //  const [selectedBGImg , setSelectedBGImg] = useState(defaultBGImg);
    ...
    return(
        <div data-testid="profile" className="mt-5 bg-background bg-signin-background bg-cover bg-no-repeat w-full min-h-[100vh] flex flex-col justify-center items-center content-center">
            ...
            <div className=" mt-5 mb-14 w-5/6 bg-background rounded-lg h-96">
                ...
                <div className="flex flex-col items-center justify-center content-center  mb-14 bg-background rounded-lg  pt-4">
                    ...
                    <h5 className="font-semibold text-[14px] sm:text-[18px] lg:text-[24px] text-primary flex flex-row m-1"> {  userEmail  } 
                        <button type="button"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-3"  >
