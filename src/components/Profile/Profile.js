...
function Profile(){
    return(
        ...
        <div className="bg-background bg-signin-background bg-cover bg-no-repeat w-full min-h-[100vh] flex flex-col justify-center items-center content-center">
            <div className="p-10 mt-14 mb-14 w-5/6 items-center justify center bg-background rounded-lg flex flex-col">
                <img src={ProfileImg2} alt="ProfileImg" className="rounded-full w-36"/>
