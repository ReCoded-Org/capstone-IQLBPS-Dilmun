        ...
        <div className="mt-14 bg-background bg-signin-background bg-cover bg-no-repeat w-full min-h-[100vh] flex flex-col justify-center items-center content-center">
            ...
            <div className=" mt-14 mb-14 w-5/6 bg-background rounded-lg ">
                <div className="relative">  
                    ...
                    <img src={selectedImg} alt="Profile Img" className="rounded-full w-36 absolute "/>
                </div>
                <div className="flex flex-col items-center justify-center content-center  mb-14 bg-background rounded-lg  pt-4">
                    ...
                    <h5 className="font-semibold text-[14px] sm:text-[18px] lg:text-[24px] text-primary flex flex-row m-1">Email  
    ...
    <div className="max-w-2xl rounded-lg shadow-xl bg-gray-50">
        <div className="m-4">
            ...
            <div className="flex items-center justify-center w-full">
                <div
                    className="flex flex-col w-80 h-24 border-4 border-dashed hover:bg-gray-100 hover:border-gray-300">
