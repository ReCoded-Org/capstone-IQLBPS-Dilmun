 ...
 function Profile(){
    ...
    return(
        <div className="mt-14 bg-background bg-signin-background bg-cover bg-no-repeat w-full min-h-[100vh] flex flex-col justify-center items-center content-center">
            ...
            <div className=" mt-14 mb-14 w-5/6 bg-background rounded-lg ">
                    <button  className="pt-4 px-4 abdolute left-100" type="button" onClick={()=>setOpen(!open)} >
                        ...
                        {/* <!-- Dropdown menu --> */
                        open && 
                        <div className = " mx-5 w-fit text-background bg-primary rounded">
                            <ul >  { /* className={viewMode} I tried to use it here but it's not working & I don't know if there is a way to put it in the above class */ }
                                ...
                                <li className="rounded hover:bg-secondary ">
                                    <button type="button" onClick={handleSelectProfile} className="block py-1 px-2 text-[14px] sm:text-[18px] lg:text-[22px]">Edit Profile info</button>
                                </li>  
                            </ul>
                    </div>}
