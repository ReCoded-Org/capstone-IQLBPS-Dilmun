...
function NavBar(){
    ...
    return(
            ...
            >
                ...
                className='object-scale-down h-20 md:justify-self-center py-0 mx-12' alt='logo'/>
                </Link>
                <div
                 className={
                ...
                <button type='submit' id='translation-icon'><img src='https://cdn.discordapp.com/attachments/1031834305703460906/1035608527923843122/translation-icon.png'
                className='h-10 justify-self-center py-0 mx-12' alt='icon'/></button>
                </div>
                <button 
