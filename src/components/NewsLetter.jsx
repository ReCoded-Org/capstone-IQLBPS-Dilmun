...
const NewsLetter = () => {
  return (
    <div className='m-14 p-4 md:flex rounded-md shadow-md justify-around bg-primary'>
      ...
      <div className='mt-4'>
        <p className='text-white mb-5'>Subscribe to our newsletter and stay updated</p>
        <div className='items-center sm:flex justify-center gap-2'>
          <input type="text" placeholder='Write your email here' className='rounded p-1 w-full sm:w-fit md:p-2 mb-3 sm:mb-0 placeholder:text-primary border border-solid ' />
