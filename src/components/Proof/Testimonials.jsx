  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-4 mb-2">
        <h2
          className="font-bold text-center xs:text-[48px] text-[40px] text-black xs:leading-[76.8px] leading-[66.8px] w-full"
        ...
        <div className="w-full md:mt-0 mt-6">
          <p
            className="font-poppins font-normal text-[20px] leading-[30.8px] text-center p-6 md:text-left md:max-w-[450px]"
