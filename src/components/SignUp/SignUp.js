...
function SignUp() {
  ...
  return (
    <div
      className="bg-background md:bg-signin-background md:bg-cover bg-no-repeat w-full min-h-[100vh] h-full flex flex-col justify-center items-center content-center"
      data-testid="sign-up"
    >
