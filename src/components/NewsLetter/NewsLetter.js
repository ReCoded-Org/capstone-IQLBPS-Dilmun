...
const NewsLetter = () => {
  ...
  return (
    <div data-testid='newsletter' className=" grid grid-col-2 pt-14 pb-14 pr-10 pl-10 hadow-md bg-background border-y-2 border-y-primary">
      <div className="text-primary flex flex-col lg:flex-row items-center lg:justify-around justify-center">
        ...
        <div className="mt-4 flex flex-col items-center justify-center">
          <p className="text-primary mb-5 lg:text-end text-center">
            ...
            and stay<br className="sm:block hidden" />updated.
          </p>
