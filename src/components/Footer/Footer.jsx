...
const Footer = () => {
    return (
        ...
        <div className=" text-center lg:text-left bg-primary  text-background">

            <div className="pt-5 mt-14 mx-6  text-center md:text-left">
          ...
          ">
                        ...
                        <p>
                            ...
                            Here at Dilmun we sell various products to customers and accept donations to help those people that are in need.
                        </p>
                    </div>
                    <div className="">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-background">Angular</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-background">React</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-background">Vue</a>
                        </p>
                        <p>
                            <a href="#!" className="text-background">Laravel</a>
                        </p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-background">Pricing</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-background">Settings</a>
                        </p>
                        <p className="mb-4">
